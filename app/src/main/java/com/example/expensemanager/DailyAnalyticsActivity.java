...
public class DailyAnalyticsActivity extends AppCompatActivity {
    ...
    private TextView totalSpentAmountTv, analyticsTransportAmount, analyticsFoodAmount, analyticsHouseAmount, analyticsEntertainmentAmount, analyticsEducationAmount, analyticsCharityAmount, analyticsApparelAmount, analyticsHealthAmount, analyticsPersonalAmount, analyticsOtherAmount, analyticsSummaryAmount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalSpentAmountTv=findViewById(R.id.totalBudgetAmountTv);
    ...
    private void setStatusAndImageResource () {
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    int transportTotal;
                    if(snapshot.hasChild("dailyTransport")){
                        transportTotal=Integer.parseInt(snapshot.child("dailyTransport").getValue().toString());
                    } else {
                        transportTotal=0;
                    }

                    int foodTotal;
                    if(snapshot.hasChild("dailyFood")){
                        foodTotal=Integer.parseInt(snapshot.child("dailyFood").getValue().toString());
                    } else {
                        foodTotal=0;
                    }

                    int houseTotal;
                    if(snapshot.hasChild("dailyHouse")){
                        houseTotal=Integer.parseInt(snapshot.child("dailyHouse").getValue().toString());
                    } else {
                        houseTotal=0;
                    }

                    int entertainmentTotal;
                    if(snapshot.hasChild("dailyEntertainment")){
                        entertainmentTotal=Integer.parseInt(snapshot.child("dailyEntertainment").getValue().toString());
                    } else {
                        entertainmentTotal=0;
                    }

                    int educationTotal;
                    if(snapshot.hasChild("dailyEducation")){
                        educationTotal=Integer.parseInt(snapshot.child("dailyEducation").getValue().toString());
                    } else {
                        educationTotal=0;
                    }

                    int healthTotal;
                    if(snapshot.hasChild("dailyHealth")){
                        healthTotal=Integer.parseInt(snapshot.child("dailyHealth").getValue().toString());
                    } else {
                        healthTotal=0;
                    }

                    int charityTotal;
                    if(snapshot.hasChild("dailyCharity")){
                        charityTotal=Integer.parseInt(snapshot.child("dailyCharity").getValue().toString());
                    } else {
                        charityTotal=0;
                    }

                    int personalTotal;
                    if(snapshot.hasChild("dailyPersonal")){
                        personalTotal=Integer.parseInt(snapshot.child("dailyPersonal").getValue().toString());
                    } else {
                        personalTotal=0;
                    }

                    int apparelTotal;
                    if(snapshot.hasChild("dailyApparel")){
                        apparelTotal=Integer.parseInt(snapshot.child("dailyApparel").getValue().toString());
                    } else {
                        apparelTotal=0;
                    }

                    int otherTotal;
                    if(snapshot.hasChild("dailyOther")){
                        otherTotal=Integer.parseInt(snapshot.child("dailyOther").getValue().toString());
                    } else {
                        otherTotal=0;
                    }
                    int todayTotal;
                    if(snapshot.hasChild("today")){
                        todayTotal=Integer.parseInt(snapshot.child("today").getValue().toString());
                    } else {
                        todayTotal=0;
                    }
                    ...
                    if(snapshot.hasChild("dayTransportRatio")){
                        transportTotalRatio=Float.parseFloat(snapshot.child("dayTransportRatio").getValue().toString());
                    } else {
                    ...
                    if(snapshot.hasChild("dayFoodRatio")){
                        foodTotalRatio=Float.parseFloat(snapshot.child("dayFoodRatio").getValue().toString());
                    } else {
                        foodTotalRatio=0;
                    }
                    ...
                    if(snapshot.hasChild("dayHouseRatio")){
                        houseTotalRatio=Float.parseFloat(snapshot.child("dayHouseRatio").getValue().toString());
                    } else {
                        houseTotalRatio=0;
                    }
                    ...
                    if(snapshot.hasChild("dayEntertainmentRatio")){
                        entertainmentTotalRatio=Float.parseFloat(snapshot.child("dayEntertainmentRatio").getValue().toString());
                    } else {
                    ...
                    if(snapshot.hasChild("dayEducationRatio")){
                        educationTotalRatio=Float.parseFloat(snapshot.child("dayEducationRatio").getValue().toString());
                    } else {
                    ...
                    if(snapshot.hasChild("dayHealthRatio")){
                        healthTotalRatio=Float.parseFloat(snapshot.child("dayHealthRatio").getValue().toString());
                    } else {
                        healthTotalRatio=0;
                    }
                    ...
                    if(snapshot.hasChild("dayCharityRatio")){
                        charityTotalRatio=Float.parseFloat(snapshot.child("dayCharityRatio").getValue().toString());
                    } else {
                        charityTotalRatio=0;
                    }
                    ...
                    if(snapshot.hasChild("dayPersonalRatio")){
                        personalTotalRatio=Float.parseFloat(snapshot.child("dayPersonalRatio").getValue().toString());
                    } else {
                    ...
                    if(snapshot.hasChild("dayApparelRatio")){
                        apparelTotalRatio=Float.parseFloat(snapshot.child("dayApparelRatio").getValue().toString());
                    } else {
                        apparelTotalRatio=0;
                    }
                    ...
                    if(snapshot.hasChild("dayOtherRatio")){
                        otherTotalRatio=Float.parseFloat(snapshot.child("dayOtherRatio").getValue().toString());
                    } else {
                        otherTotalRatio=0;
                    }
                    ...
                    if(snapshot.hasChild("dailyBudget")){
                        dailyTotalRatio=Float.parseFloat(Objects.requireNonNull(snapshot.child("dailyBudget").getValue()).toString());
                    } else {
                        dailyTotalRatio=0;
                    }
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    Log.i("datass",String.valueOf(transportTotal)+" "+otherTotal);
                    ...
                    Toast.makeText(DailyAnalyticsActivity.this, "Child does not exists",Toast.LENGTH_LONG).show();
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    personalRef.child("dailyOther").setValue(totalAmount);
                } else {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    personalRef.child("dailyPersonal").setValue(totalAmount);
                } else {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    personalRef.child("dailyHealth").setValue(totalAmount);
                } else {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    personalRef.child("dailyApparel").setValue(totalAmount);
                } else {
    ...
    private void getTotalCharityExpense() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                personalRef.child("dailyCharity").setValue(totalAmount);
                } else {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    personalRef.child("dailyEducation").setValue(totalAmount);
                } else {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    personalRef.child("dailyEntertainment").setValue(totalAmount);
                } else {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    personalRef.child("dailyHouse").setValue(totalAmount);
                } else {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    personalRef.child("dailyFood").setValue(totalAmount);
                } else {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    personalRef.child("dailyTransport"+date).setValue(totalAmount);
                } else {
